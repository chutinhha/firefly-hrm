...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApplyLeaveUserControl.ascx.cs" Inherits="SP2010VisualWebPart.User.Leave.ApplyLeave.ApplyLeaveUserControl" %>
    ...
    <table class="fieldTitleDiv" cellpadding="0">
        <tr>
            <td>
                ...
                <br />
                <span style="padding-left:5px"></span><asp:Label ID="lblLeave" runat="server" 
        Text="Leave Type(*)" Width="150px"></asp:Label>
