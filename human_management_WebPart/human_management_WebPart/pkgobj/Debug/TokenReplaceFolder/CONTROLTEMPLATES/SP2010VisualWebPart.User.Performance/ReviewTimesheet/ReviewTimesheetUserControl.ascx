...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReviewTimesheetUserControl.ascx.cs" Inherits="SP2010VisualWebPart.User.Performance.ReviewTimesheet.ReviewTimesheetUserControl" %>
...
<asp:Button ID="btnView" class="addButton" runat="server" Text="View" Width="80px" 
    ...
    <br>
        &nbsp;<asp:Label ID="lblDetail" runat="server" Text=""></asp:Label><br><br></asp:Panel>
