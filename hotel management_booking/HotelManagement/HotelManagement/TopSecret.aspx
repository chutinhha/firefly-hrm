<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TopSecret.aspx.cs" Inherits="HotelManagement.TopSecret" %>
...
<asp:Panel ID="pnlNew" runat="server">
    ...
    <div class="sitemap">
                <ul>
                    ...
                    <li ><a href="Moving.aspx">Moving</a></li>
                    <li class="current"><a href="TopSecret.aspx">Top Secret</a></li>
                </ul>
            </div>
            <br />
