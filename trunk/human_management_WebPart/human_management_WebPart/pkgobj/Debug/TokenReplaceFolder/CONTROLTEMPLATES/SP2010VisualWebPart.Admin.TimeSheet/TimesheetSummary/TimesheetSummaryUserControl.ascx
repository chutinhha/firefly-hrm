...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TimesheetSummaryUserControl.ascx.cs" Inherits="SP2010VisualWebPart.Admin.TimeSheet.TimesheetSummary.TimesheetSummaryUserControl" %>
...
<asp:Button ID="btnView" class="addButton" runat="server" Text="View" Width="80px" 
        ...
        <asp:Button ID="btnReset" runat="server" Text="Reset" Width="80px" 
            class="resetButton" onclick="btnReset_Click"/>
    </div>

    <asp:Panel ID="pnlData" runat="server" Visible="False"><br>
        <asp:Label ID="lblDetail" runat="server" Text=""></asp:Label><br><br>
