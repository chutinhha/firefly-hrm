...
<%@ Register TagPrefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
    Assembly="Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditCandidateUserControl.ascx.cs"
    Inherits="SP2010VisualWebPart.EditCandidate.EditCandidateUserControl" %>
            ...
            <td>
                <table class="fieldTitleTable">
                    <tr>
                        <td class="fieldTitleTd">
                            <font color="white">Edit Candidate</font>
                        </td>
                    </tr>
                </table>
                <br>
                ...
                <p>
                    ...
                    <asp:Panel ID="pnlApplyDate" runat="server" Style="display: inline;">
                        <input type="text" id="txtApplyDate" name="txtApplyDate" style="width:200px;" value="<%= this.inputValue %>" />
                    </asp:Panel>
                    &nbsp;<p>
                    </p>
                    <br>
                    ...
                    <asp:Panel ID="pnlInterview" runat="server" Style="display: inline;">
                        <input type="text" id="txtInterviewDate" name="txtInterviewDate" style="width:200px;" value="<%= this.interviewDate %>" />
                    </asp:Panel>
                    <span style="padding-left: 100px;"></span>
                    ...
                    <p>
                        <br>
                        <span style="padding-left: 5px;"></span>
                        <asp:Label ID="lblComment" runat="server" Text="Comment" valign="top" Width="120px"></asp:Label>
                    </p>
                    ...
                    <div class="borderTop">
                        <span style="padding-left: 130px;"></span>
                        <asp:Button ID="btnSave" runat="server" class="addButton" OnClick="btnSave_Click"
                            OnClientClick="return confirm('Are you sure you want to save ?')" Text="Save"
                            Width="80px" />
                        <asp:Button ID="btnCancel" runat="server" class="resetButton" OnClick="btnCancel_Click"
